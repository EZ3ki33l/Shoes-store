...
const navigationMenuTriggerStyle = cva(
  'group/navigation-menu-trigger inline-flex h-9 w-max items-center justify-center rounded-lg px-2.5 py-1.5 text-sm font-medium transition-all outline-none hover:bg-secondary-50 focus:bg-secondary-50 focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-popup-open:bg-secondary-50/50 data-popup-open:hover:bg-secondary-50 data-open:bg-secondary-50/50 data-open:hover:bg-secondary-50 data-open:focus:bg-secondary-50',
)
...
function NavigationMenuLink({ className, ...props }: NavigationMenuPrimitive.Link.Props) {
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "hover:bg-secondary-50 focus:bg-secondary-50 focus-visible:ring-ring/50 data-active:bg-secondary-50/50 data-active:hover:bg-secondary-50 data-active:focus:bg-secondary-50 flex items-center gap-2 rounded-lg p-2 text-sm transition-all outline-none focus-visible:ring-3 focus-visible:outline-1 in-data-[slot=navigation-menu-content]:rounded-md [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
