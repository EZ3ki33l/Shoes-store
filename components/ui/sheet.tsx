      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            className="text-muted-foreground hover:bg-muted hover:text-foreground absolute top-3 right-3 inline-flex size-8 cursor-pointer items-center justify-center rounded-md transition-colors"
          >
